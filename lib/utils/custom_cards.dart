...
Widget academyCard(String url, String name, String description,
...
Widget tournamentcard(String url, String name, String description,
    {double verticalmargin = 5}) {
  return Padding(
...
Widget experincecard(String url, String name, String description,
    {double verticalmargin = 5}) {
  return Padding(
    padding: const EdgeInsets.all(8.0),
    child: Container(
...
Widget venuecard(String url, String name, String address) {
  return Container(
    width: MediaQuery.of(Get.context!).size.width * 0.9,
