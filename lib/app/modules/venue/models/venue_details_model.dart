...
VenueDetails? venueDetailsFromJson(String str) => VenueDetails.fromJson(json.decode(str));
...
class Datum {
    ...
    factory Datum.fromJson(Map<String, dynamic> json) => Datum(
        ...
        facilities: json["facilities"] == null ? [] : json["facilities"] is List ? List<Facility>.from(json["facilities"]!.map((x) => Facility.fromJson(x))) : [],
        rating: json["rating"] == null ? [] : json["rating"] is List ? List<RatingElement>.from(json["rating"]!.map((x) => RatingElement.fromJson(x))):[],
        sportsDetails: json["sports_details"] == null ? [] : json["sports_details"] is List ? List<SportsDetail>.from(json["sports_details"]!.map((x) => SportsDetail.fromJson(x))) : [],
    ...
    Map<String, dynamic> toJson() => {
        ...
        "sports_details": sportsDetails == null ? [] : List<dynamic>.from(sportsDetails!.map((x) => x.toJson())),
        "amenities_details": amenitiesDetails == null ? [] : List<dynamic>.from(amenitiesDetails!.map((x) => x.toJson())),
    };
}
