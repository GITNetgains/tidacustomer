...
AcademyFullDetailResponse? academyFullDetailResponseFromJson(String str) =>
    AcademyFullDetailResponse.fromJson(json.decode(str));

String academyFullDetailResponseToJson(AcademyFullDetailResponse? data) =>
...
class AcademyFullDetailResponse {
  ...
  factory AcademyFullDetailResponse.fromJson(Map<String, dynamic> json) =>
      AcademyFullDetailResponse(
        status: json["status"],
...
class Datum {
  ...
  factory Datum.fromJson(Map<String, dynamic> json) => Datum(
        ...
        amenitiesDetails: json["amenities_details"] == null
            ...
            : json["amenities_details"] is List
                ...
                : [],
        venueDetails: json["venue_details"] == null
            ? []
            : json["venue_details"] is List
                ? List<VenueDetail?>.from(
                    json["venue_details"]!.map((x) => VenueDetail.fromJson(x)))
                : [],
  ...
  Map<String, dynamic> toJson() => {
        ...
        "venue_details": venueDetails == null
            ...
            : venueDetails == null
                ? []
                : List<dynamic>.from(venueDetails!.map((x) => x!.toJson())),
      };
}
